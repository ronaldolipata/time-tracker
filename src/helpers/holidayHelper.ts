 ...
 */
export const calculateTotalSpecialNonWorkingHoliday = (
  timeEntries: TimeEntry[],
  holidays: Holidays
): number => {
  if (!Array.isArray(timeEntries) || timeEntries.length === 0) return 0;
 ...
 */
export const calculateTotalSpecialWorkingHoliday = (
  timeEntries: TimeEntry[],
  holidays: Holidays
): number => {
 ...
 */
export const isSpecialNonWorkingHoliday = (date: string, holidays: Holidays): boolean => {
 ...
 */
export const isSpecialWorkingHoliday = (date: string, holidays: Holidays): boolean => {
